...
// Источники: abTest.js, progress.js, remoteConfig.js. Пересобрать: node client/build-iife.mjs
//
...
async function initRemoteConfig(opts) {
  ...
  global.RemoteConfig = { initRemoteConfig, rc, rcAll, rcReady, rcCohorts, installId, configure, pickGroups, groupLabel, progressParams, cohortLabel };
