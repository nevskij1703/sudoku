...
window.RC_DECLARATION = {
  ...
  "_scope": "Ритм рекламы, просьба об оценке, генератор уровней и общая сложность (сдвиг открытых клеток, пороги лейбла). НЕ вынесены сердечки и подсказки: их стартовые значения ЗАПИСЫВАЮТСЯ В СЕЙВ при создании уровня, и правка из бакета означала бы правку формата сейва задним числом. Хуже того, по равенству `active.hearts === heartsPerLevel` игра решает, свежий ли уровень (game.js) — сменившееся число сломало бы эту проверку молча.",
  "defaults": {
